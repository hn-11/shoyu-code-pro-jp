...
`narrow_letters` が全部 1 セルに揃える。詰め方はセル / 送り幅の比率
（半角ハングルと同じ）なので、ドナー自身のサイドベアリングが比例して
残る。ほとんどは 602 幅で 0.3% 縮むだけ、`Μ Ж М Ф Ш Щ Ъ Ы Ю ж ф ш щ ю`
の 14 字が 755〜1005 から本当に詰まる。等幅フォントが幅広の字にするのと
同じ扱いで、Source Code Pro 自身の `M` も 600。
